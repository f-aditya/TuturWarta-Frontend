...
import Label from "../../Label"; // plasmic-import: pDfoZTzi1eZA/component
import TextInput from "../../TextInput"; // plasmic-import: tCfabMpvVoU8/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: Lr-gBjYbAXBR/component
import Description from "../../Description"; // plasmic-import: ce6nsOmBo8s9/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: USj-9XREqnyg/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__wqbrE, {
          [sty.freeBoxiconEnd__wqbrEm2VLh]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__wqbrEq7Kst]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__wqbrErxhsr]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__ooVT, {
            [sty.freeBoxiconStart__ooVTQ7Kst]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__ooVTRxhsr]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__aUkp3)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__ncri8, {
            [sty.freeBoxiconEnd__ncri8M2VLh]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__ncri8Q7Kst]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__nuIZk)}
                role={"img"}
              />
            ),
