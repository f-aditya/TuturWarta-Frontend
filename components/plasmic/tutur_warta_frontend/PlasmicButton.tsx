...
import sty from "./PlasmicButton.module.css"; // plasmic-import: MfyGhdfFxPFg/css

import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: D9HBUGdZwT5W/icon
import ChevronDown2Icon from "./icons/PlasmicIcon__ChevronDown2"; // plasmic-import: ML-ts2H5OR5T/icon
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__qMZrG, {
          [sty.freeBoxcolor_neutral__qMZrGc3Gfp]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__qMZrGPaATB9Er]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxcolor_white__qMZrGzGad]: hasVariant(
            $state,
            "color",
            "white"
          ),
          [sty.freeBoxroundedFull__qMZrGe0DOy]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__qMZrG9NtEz]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__qMZrGk98Qi]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__qMZrGmxwxf]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__qMZrGnbig3]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__qMZrGtB9Er]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__iuqBo, {
            [sty.freeBoxcolor_neutral__iuqBoc3Gfp]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__iuqBolXTta]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__iuqBo9NtEz]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__iuqBoMxwxf]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__iuqBoNbig3]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__iuqBotB9Er]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__iuqBo0Ehd8C3Gfp]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__uNIp)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___1UFRt, {
            [sty.freeBoxiconEnd___1UFRti5MYl]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge___1UFRt9NtEz]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large___1UFRtMxwxf]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___1UFRtNbig3]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDown2Icon
                className={classNames(projectcss.all, sty.svg___91FD)}
                role={"img"}
              />
            ),
