...
import sty from "./PlasmicOverlayArrow.module.css"; // plasmic-import: gpYNmqBw_SV1/css

import TriangleFilledIcon from "./icons/PlasmicIcon__TriangleFilled"; // plasmic-import: Dbktw8dHFUF9/icon
