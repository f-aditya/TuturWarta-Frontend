...
import Button2 from "../../Button2"; // plasmic-import: prz0T0Jga10p/component
...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: hSHeL4PLVNCi/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_KV2U1l-lRO-t"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__qy7Sn)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <h2
                    className={classNames(
              ...
              <div className={classNames(projectcss.all, sty.freeBox__aXoPz)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__xi818)}
                    >
                      <Button2
                        color={"muted"}
                        label={"Close"}
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button2
                  className={classNames("__wab_instance", sty.button2__raeFq)}
                  label={
                    <div
                      className={classNames(
                        projectcss.all,
