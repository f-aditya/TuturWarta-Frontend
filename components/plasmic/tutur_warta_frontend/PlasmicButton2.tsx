...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: prz0T0Jga10p/css
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__hIrC, {
          [sty.freeBoxcolor_neutral__hIrC4Ac80]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__hIrC9C0ByS3Zi]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull__hIrCfQfl]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__hIrC0Nm2H]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__hIrC6TDxc]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__hIrCX5Anl]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__hIrCbtcBk]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__hIrCS3Zi]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___9PEwj, {
            [sty.freeBoxcolor_neutral___9PEwj4Ac80]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft___9PEwj4Ac80Kkg9V]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart___9PEwjVyl0M]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge___9PEwj0Nm2H]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large___9PEwjX5Anl]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___9PEwjbtcBk]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered___9PEwjS3Zi]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__i9Hp3)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__wNvNv, {
            [sty.freeBoxiconEnd__wNvNvUlKrp]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__wNvNv0Nm2H]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__wNvNvx5Anl]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__wNvNVbtcBk]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDown2Icon
                className={classNames(projectcss.all, sty.svg__jr0RK)}
                role={"img"}
              />
            ),
