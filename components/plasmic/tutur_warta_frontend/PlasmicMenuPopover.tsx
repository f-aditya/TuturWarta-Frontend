...
import sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: MnOfyQ1dxWEQ/css
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  ...
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__mnkK)}
                    label={"Item 2"}
                    value={"item2"}
                  />

                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__zakU)}
                    label={"Item 3"}
                    value={"item3"}
                  />
