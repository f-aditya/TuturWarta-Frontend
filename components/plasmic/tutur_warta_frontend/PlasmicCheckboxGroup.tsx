...
import Checkbox from "../../Checkbox"; // plasmic-import: 0dCyTAJN_A0i/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: LNbgNX39aoFh/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__aCea2)}
          >
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__pntjI)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__ckkZi)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__sjFhp)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
