...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: pSreqkYWAF93/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox___1GvuX)}>
        <div className={classNames(projectcss.all, sty.freeBox__lImFy)} />
      </div>
      {renderPlasmicSlot({
