...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: gpYNmqBw_SV1/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: faLdNH5ftWbm/css
  ...
  return (
    <BaseDialogTrigger
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__ctCbv)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button2
            className={classNames("__wab_instance", sty.button2___61JX)}
            label={"Open Popover"}
          />
        ),
