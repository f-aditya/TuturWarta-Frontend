...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: Aj5cntZ0Tx8l/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__fShQe)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__fnOmn)}>
            <div
              className={classNames(
                projectcss.all,
