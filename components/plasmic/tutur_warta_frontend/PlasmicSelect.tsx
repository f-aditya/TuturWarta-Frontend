...
import MenuPopover from "../../MenuPopover"; // plasmic-import: MnOfyQ1dxWEQ/component
import MenuItem from "../../MenuItem"; // plasmic-import: Aj5cntZ0Tx8l/component
import MenuSection from "../../MenuSection"; // plasmic-import: B7jgHUBzBrKN/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: ISZpNlbgL90e/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__n6JeN)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
