...
import SliderThumb from "../../SliderThumb"; // plasmic-import: LknYwCCpip9l/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: tUNAzSHGrE73/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__i5IQo)}
      >
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__pnm45)}>
        <div
