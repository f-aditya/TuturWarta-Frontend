...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: 1EfRnQNWIycQ/css
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___1UpRn)}
        >
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__ooL0H)}>
        <div
