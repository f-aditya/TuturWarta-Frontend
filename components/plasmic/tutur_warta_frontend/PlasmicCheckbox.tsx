...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: 0dCyTAJN_A0i/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: kcDFGYUacHMl/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: IMHnxDUBDybO/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg___4RkJb)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__eE3Y)}
            role={"img"}
          />
        ) : null}
      </div>
