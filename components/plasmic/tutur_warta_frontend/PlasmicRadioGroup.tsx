...
import Radio from "../../Radio"; // plasmic-import: pSreqkYWAF93/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: D0RCl_hBtl-k/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__zDpS)}
          >
            <Radio
              className={classNames("__wab_instance", sty.radio___5YqOr)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__nF8Z)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__y0Ueb)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
