...
import sty from "./PlasmicModal.module.css"; // plasmic-import: OElaiOFB5khR/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_JUVtEczFkVu1"]]: true })}
        ...
        >
          ...
          >
              ...
              {renderPlasmicSlot({
                defaultContents: (
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__a0LLr)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <div
                  className={classNames(projectcss.all, sty.freeBox___4QiDi)}
                >
                  <Button2
                    color={"muted"}
                    label={
